...
urlpatterns = [
    ...
    path('admin/business-team/', views.business_team_list, name='business_team_list'),
    path('admin/business-team/add/', views.business_team_add, name='business_team_add'),
    path('admin/business-team/<int:pk>/edit/', views.business_team_edit, name='business_team_edit'),
    path('admin/business-team/<int:pk>/delete/', views.business_team_delete, name='business_team_delete'),
